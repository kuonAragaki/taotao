...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		$(function(){
		    $("#online-pay1").click(function (){
		        $("#online-pay").addClass("item-selected");
                $("#offline-pay").removeClass("item-selected");
				$("input[name=paymentType]").val("4");
		    });
		}
		);
        $(function(){
                $("#offline-pay1").click(function (){
                    $("#offline-pay").addClass("item-selected");
                    $("#online-pay").removeClass("item-selected");
	...
	<div class="payment-list" id="">
		<div class="list-cont">
			<ul id="payment-list">
				...
				<li style="cursor: pointer;" id="offline-pay1">
					<div class="payment-item item-selected online-payment "
						for="pay-method-1" payname="货到付款" payid="1" id="offline-pay">
				...
				<li style="cursor: pointer;" id="online-pay1">

					<div class="payment-item  online-payment "
						for="pay-method-4" payname="在线支付" payid="4" id="online-pay">
