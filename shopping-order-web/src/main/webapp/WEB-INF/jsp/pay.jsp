...
<div class="w main">
	<div class="m m3 msop">
        <div class="mt" id="success_tittle"><s class="icon-succ02"></s><h3 class="ftx-02">感谢您，订单提交成功，请选择支付方式</h3>
		</div>
		<div class="mc" id="success_detail">	
		    <ul class="list-order">
				...
				<p>
					工商银行:<input type="radio" name="pdFrpId" value="ICBC-NET-B2C"/>
					<img src="/images/bankicbc.gif" alt="工商银行"/>
				</p>
				<p>
					招商银行:<input type="radio" name="pdFrpId" value="CMBCHINA-NET-B2C"/>
					<img src="/images/bankcmb.gif" alt="招商银行"/>
				</p>
				<p>
					建设银行:<input type="radio" name="pdFrpId" value="CCB-NET-B2C"/>
					<img src="/images/bankccb.gif" alt="建设银行"/>
				</p>
				<p>
					农业银行:<input type="radio" name="pdFrpId" value="ABC-NET-B2C"/>
					<img src="/images/bankabc.gif" alt="农业银行"/>
				</p>
				<p>
					<button value="在线支付" onclick="pay()">在线支付</button>
				</p>
		<!-- 在线支付按钮  -->
				<div id="bookDiv"></div>
 					<p class="i-tips01">
...
<script type="text/javascript">
    function pay() {
		window.location.href = "http://localhost:8107/pay.html?orderId=${orderId }&payment=${payment}&pdFrpId="+$("input:checked").val();
    }
</script>
</html>