...
public class TestSolrJ {
    ...
    public void testSolrJAddDocument() throws  Exception{
        ...
        //如果有多个collection.则需要指定要操作那个collection，如果只有一个，可以不指定
        HttpSolrServer solrServer = new HttpSolrServer("http://192.168.200.128:8080/solr");

        //向文档中添加域，添加域这里面有一个要求，必须有一个id域，域必须在shema.xml中定义
        for (int i = 0; i < 2; i++) {
             //创建一个文档对象，即SolrInputDocument对象
            SolrInputDocument document = new SolrInputDocument();
            document.addField("id","test002"+i);
...
//        // 通过id来删除文档
//        solrServer.deleteById("test0021");
//        // 提交
//        solrServer.commit();
//    }
//
