	...
	<script type="text/javascript">
        ...
        function countDown(){//传入终止时间
            ...
            if(countTime<=0) {
                ...
                var mytime = setTimeout("countDown()",1000);
            }
        }
...
<body version="140120" onload="countDown()">
...
<div class="w">
	<div id="product-intro" >
		<div id="name">
			<h1>${item.title }&nbsp;&nbsp;<span style="color:lightskyblue;font-size:1px;text-align:center;" id="countDown"></span></h1>
			...
			<ul id="choose" clstag="shangpin|keycount|product|choose">
				...
				<li id="choose-btns">
					<div id="choose-btn-append"  class="btn">
						...
						<a style="background-color: #6cb247;color: white;width: 150px" href="http://localhost:8106/sk/order/order-cart/${item.id}.html">立即抢购</a>
					</div>
