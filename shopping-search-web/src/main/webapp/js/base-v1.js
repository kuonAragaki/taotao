 ...
 */
function login() {
    return location.href = "http://localhost:8101/page/login";
}
function regist() {
    return location.href = "http://localhost:8101/page/register";
}
...
function search(a) {
    var b = "http://127.0.0.1:8097/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
